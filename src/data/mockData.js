export const mockData = {
  ...
  goals: {
    today: [
      { id: 1, text: "Sprint training: 5 × 100m at 85% intensity, record times", completed: true, category: "Health", pillar: "Health" },
      { id: 2, text: "Read Chapter 5 of Nielsen & Chuang (Quantum Fourier Transform)", completed: false, category: "Academics", pillar: "Academics" },
      { id: 3, text: "Summarize top 3 geopolitical news stories in argument journal", completed: false, category: "Career", pillar: "Career" },
      { id: 4, text: "Code quantum circuit visualization for 2-qubit system", completed: false, category: "Passions", pillar: "Passions" },
      { id: 5, text: "Review and optimize PCB layout for noise reduction", completed: false, category: "Passions", pillar: "Passions" },
      { id: 6, text: "Practice debate opening statement (8 minutes)", completed: true, category: "Career", pillar: "Career" },
      { id: 7, text: "Complete strength training: squats, deadlifts, plyometrics", completed: false, category: "Health", pillar: "Health" },
      { id: 8, text: "Write reflection on today's quantum mechanics insights", completed: false, category: "Academics", pillar: "Academics" }
    ],
    weekly: [
      { id: 1, text: "Improve 100m sprint time by 0.1s (current: 11.7s avg)", completed: false, progress: 70, target: 1, category: "Health", pillar: "Health" },
      { id: 2, text: "Complete 3 chapters of quantum computing textbook", completed: false, progress: 66, target: 3, category: "Academics", pillar: "Academics" },
      { id: 3, text: "Research and write 2 geopolitical analysis pieces", completed: false, progress: 50, target: 2, category: "Career", pillar: "Career" },
      { id: 4, text: "Finish PCB design for quantum visualizer prototype", completed: false, progress: 80, target: 1, category: "Passions", pillar: "Passions" },
      { id: 5, text: "Attend 2 football training sessions", completed: false, progress: 50, target: 2, category: "Health", pillar: "Health" },
      { id: 6, text: "Practice 5 debate scenarios with timer", completed: false, progress: 40, target: 5, category: "Career", pillar: "Career" },
      { id: 7, text: "Read 50 pages of psychology book", completed: false, progress: 60, target: 50, category: "Passions", pillar: "Passions" }
    ],
    monthly: [
      { id: 1, text: "Achieve consistent sub-11.5s 100m sprint times", completed: false, progress: 75, target: 1, category: "Health", pillar: "Health" },
      { id: 2, text: "Apply to 2 UK university summer research programs", completed: false, progress: 30, target: 2, category: "Academics", pillar: "Academics" },
      { id: 3, text: "Register and prepare for regional MUN conference", completed: false, progress: 85, target: 1, category: "Career", pillar: "Career" },
      { id: 4, text: "Complete and test quantum state visualizer prototype", completed: false, progress: 60, target: 1, category: "Passions", pillar: "Passions" },
      { id: 5, text: "Finish reading 'Sapiens' and write comprehensive review", completed: false, progress: 40, target: 1, category: "Passions", pillar: "Passions" },
      { id: 6, text: "Win local debate competition or reach semifinals", completed: false, progress: 20, target: 1, category: "Career", pillar: "Career" },
      { id: 7, text: "Publish blog post on quantum computing for beginners", completed: false, progress: 45, target: 1, category: "Academics", pillar: "Academics" },
      { id: 8, text: "Maintain 90% workout consistency (27/30 days)", completed: false, progress: 80, target: 27, category: "Health", pillar: "Health" }
    ],
  },

  analytics: {
    weeklyProgress: [
      { name: 'Mon', Health: 90, Academics: 85, Passions: 75, Relationship: 70, Career: 80 },
      { name: 'Tue', Health: 85, Academics: 90, Passions: 80, Relationship: 75, Career: 85 },
      { name: 'Wed', Health: 95, Academics: 75, Passions: 85, Relationship: 80, Career: 90 },
      { name: 'Thu', Health: 88, Academics: 80, Passions: 70, Relationship: 85, Career: 95 },
      { name: 'Fri', Health: 92, Academics: 95, Passions: 90, Relationship: 90, Career: 85 },
      { name: 'Sat', Health: 80, Academics: 70, Passions: 95, Relationship: 95, Career: 75 },
      { name: 'Sun', Health: 85, Academics: 85, Passions: 88, Relationship: 85, Career: 90 },
    ],
    monthlyStreaks: [
      { month: 'Sep', streak: 18 },
      { month: 'Oct', streak: 25 },
    ...
    categoryPerformance: [
      ...
      { subject: 'Academics', A: 88, fullMark: 100 },
      { subject: 'Passions', A: 85, fullMark: 100 },
      { subject: 'Relationship', A: 78, fullMark: 100 },
      { subject: 'Career', A: 82, fullMark: 100 },
  ...
  milestones: {
    ...
    Relationship: [
      { id: 1, title: "Strengthen family bonds through weekly quality time", completed: false, targetDate: "2025-12-31", progress: 60 },
      { id: 2, title: "Build meaningful friendships in new environment", completed: false, targetDate: "2025-08-31", progress: 35 },
      { id: 3, title: "Develop mentorship relationships with seniors", completed: false, targetDate: "2025-06-30", progress: 45 }
    ]
  },

  currentFocus: {
    Health: "Intensive sprint training to break 11-second barrier by year-end",
    Academics: "Mastering quantum circuit design and preparing for UK university applications",
    Passions: "Building quantum state visualizer while exploring intersection of technology and consciousness",
    Relationship: "Building deeper connections with family and developing new friendships",
    Career: "Developing expertise in India-China geopolitical relations for upcoming MUN"
  },

  achievements: [
    { id: 1, title: "20-Day Workout Streak", date: "2025-01-08", pillar: "Health", icon: "🔥" },
    { id: 2, title: "First Quantum Circuit Simulation", date: "2025-01-05", pillar: "Academics", icon: "⚛️" },
    { id: 3, title: "Won School Debate Championship", date: "2024-12-15", pillar: "Career", icon: "🏆" },
    { id: 4, title: "Completed PCB Design Course", date: "2024-12-10", pillar: "Passions", icon: "🔧" },
    { id: 5, title: "Sub-12 Second 100m Sprint", date: "2024-11-28", pillar: "Health", icon: "⚡" }
  ],
